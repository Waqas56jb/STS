...
export function adminTrainingApi(businessId) {
  ...
  return {
    ...
    deleteKnowledge: (id) => apiDelete(`/admin/knowledge/${id}`),
    uploadFile: (file, fields) => apiUpload(`${base}/knowledge/upload`, file, fields),
    loadBot: (channel) => apiGet(`${base}/bots/${channel}`),
    saveBot: (channel, body) => apiPut(`${base}/bots/${channel}`, body),
    loadProfile: () => apiGet(`${base}/profile`),
    saveProfile: (body) => apiPut(`${base}/profile`, body),
  }
}
